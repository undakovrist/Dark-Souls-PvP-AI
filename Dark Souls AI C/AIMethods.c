...
static void kick(JOYSTICK_POSITION * iReport) {
	...
	if ((Player.animationType_id != 0) || curTime < startTimeAttack + inputDelayForKick) {
	...
	if ((225 < curTime - startTimeAttack) && (250 > curTime - startTimeAttack)); {
	...
	//end subanimation on recover animation
	if ((curTime > 250) && (Player.subanimation > AttackSubanimationWindupGhostHit)) {
